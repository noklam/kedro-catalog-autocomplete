...
# kedro_catalog_autocomplete documentation build
...
from kedro_catalog_autocomplete import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_catalog_autocomplete"
author = "Kedro"
...
htmlhelp_basename = "kedro_catalog_autocompletedoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_catalog_autocomplete.tex",
        "kedro_catalog_autocomplete Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_catalog_autocomplete",
        "Project kedro_catalog_autocomplete codebase.",
        "Data-Science",
    )
]
